...
define ('IBLOCK_ID_EVENTS', 37); // ИБ о компании -> события
define ('IBLOCK_ID_DEPARTMENTS', 38); // ИБ отделы
define ('IBLOCK_ID_EMPLOYEES', 39); // ИБ Сотрудники
define ('IBLOCK_ID_BRANDS', 20); // ИБ Производители
define ('IBLOCK_ID_TRACKING', 40); // ИБ Отслеживание товаров
define ('IBLOCK_ID_RECLAMATIONS', 41); // ИБ Рекламации
define ('IBLOCK_ID_PRICELIST', 42); // ИБ Прайс-листы
define ('IBLOCK_ID_MAIN_BLOCK', 43); // ИБ Блок на главной о компании
define ('IBLOCK_ID_VACANCIES', 44); // ИБ Вакансии
define ('IBLOCK_ID_ADVICES', 45); // ИБ Советы
define ('IBLOCK_ID_COMMENTS', 46); // ИБ Комментарии
define('IBLOCK_ID_ESHOP', 47); // ИБ Интернет-магазин
define('IBLOCK_ID_ABOUT', 48); // ИБ О нас
define('IBLOCK_ID_USER_HELP', 49); // ИБ Помощь пользователям
define('IBLOCK_ID_SITE_SETTINGS', 52); // ИБ Настройки сайта
...
define ('IBLOCK_ID_CATALOG_TEST', 18);//ИБ Товары