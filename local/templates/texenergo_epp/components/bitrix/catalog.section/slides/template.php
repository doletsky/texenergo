...
<?switch($layout):
	...
	<?case 2:?>
		...
		<div class="banner-first">
			<a href="<?=$p2['LINK']['VALUE']?>">
				<img src="<?=$img2?>" alt="<?=$p2['DESCR']['VALUE']?>">
			</a>
		</div>
	...
	<?case 3:?>
		...
		<div class="banner-first">
			<a href="<?=$p3['LINK']['VALUE']?>">
				<img src="<?=$img3?>" alt="<?=$p3['DESCR']['VALUE']?>">
			</a>
		</div>
	...
	<?case 5:?>
		...
		<div class="banner-first fixed-half">
			...
			<a class="left" href="<?=$p4['LINK']['VALUE']?>">
				<img src="<?=$img4?>" alt="<?=$p4['DESCR']['VALUE']?>">
			</a>
		</div>
	...
	<?case 6:?>
		...
		<div class="banner-third">
			<a href="<?=$p3['LINK']['VALUE']?>">
				<img src="<?=$img3?>" alt="<?=$p3['DESCR']['VALUE']?>" class="first-half">
			</a>
			<a href="<?=$p4['LINK']['VALUE']?>">
				<img src="<?=$img4?>" alt="<?=$p4['DESCR']['VALUE']?>" class="second-half">
			</a>
		</div>
	...
	<?case 7:?>
		...
		<div class="banner-third">
			<a href="<?=$p2['LINK']['VALUE']?>">
				<img src="<?=$img2?>" alt="<?=$p2['DESCR']['VALUE']?>" class="first-half">
			</a>
			<a href="<?=$p3['LINK']['VALUE']?>">
				<img src="<?=$img4?>" alt="<?=$p3['DESCR']['VALUE']?>" class="second-half">
			</a>
		</div>
		<div class="banner-third">
			<a href="<?=$p4['LINK']['VALUE']?>">
				<img src="<?=$img3?>" alt="<?=$p4['DESCR']['VALUE']?>" class="first-half">
			</a>
			<a href="<?=$p5['LINK']['VALUE']?>">
				<img src="<?=$img5?>" alt="<?=$p5['DESCR']['VALUE']?>" class="second-half">
			</a>
		</div>
