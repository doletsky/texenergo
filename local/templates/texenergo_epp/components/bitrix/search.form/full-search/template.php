...
<form action="<?= $arResult["FORM_ACTION"] ?>">
    <input id="js-search-full" type="text" class="searchbar searchbar-header" name="q" value="" size="15" maxlength="50"
           autocomplete="off" placeholder="Я ищу..."/>
    <button class="searbar-button" type="submit" id="search-button-head"></button>
