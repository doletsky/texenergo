...
?>
<div class="hidden" id="seria-top-pagination-value">
    <ul class="pPager right">
        <?
            ...
            do
            {
                ...
                if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):
                    if($arResult["nStartPage"] == $arResult["NavPageCount"] && $arResult["bSavePage"] == false) {
                        ?>
                        <li><a class="pagerCurrent" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=$NavRecordGroupPrint?></a></li>
                        <?
                    } else {
                        ?>
                        <li><a class="pagerCurrent" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["nStartPage"]?>"><?=$NavRecordGroupPrint?></a></li>
                        <?
                    }
            ...
            do
            {
                if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):
                    if($arResult["nStartPage"] == 1 && $arResult["bSavePage"] == false) {
                        ?>
                        <li><a class="pagerCurrent" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=$arResult["nStartPage"]?></a></li>
                        <?
                    } else {
                        ?>
                        <li><a class="pagerCurrent" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["nStartPage"]?>"><?=$arResult["nStartPage"]?></a></li>
                        <?
                    }
...
<script type="text/javascript">
    BX.ready(function(){
        $("#seria-top-pagination").html($("#seria-top-pagination-value").html());
    }); 
</script>