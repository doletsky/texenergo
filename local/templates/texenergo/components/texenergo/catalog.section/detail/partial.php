    ...
    <article class="pProductInLine clearfix" id="<? echo $strMainID; ?>">
        ...
        <section class="pLineOverview">
            ...
            if ($arItem["PROPERTIES"]["REFERENCE"]["VALUE"] != "") {
                echo "<span class='sku sku-pline'>Референс: " . $arItem["PROPERTIES"]["REFERENCE"]["VALUE"] . "</span>";
            }
            if ($arItem["PROPERTIES"]["SKU"]["VALUE"] != "") {
                echo "<span class='sku sku-pline'>Артикул: " . $arItem["PROPERTIES"]["SKU"]["VALUE"] . "</span>";
            }
            ?>
            ...
            if ($arItem["PREVIEW_TEXT"] != "") {
                echo "<div class='copy-pline'>" . $arItem["PREVIEW_TEXT"] . "</div>";
            }
