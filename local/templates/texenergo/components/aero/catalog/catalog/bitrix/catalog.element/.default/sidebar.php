...
<? if ($USER->isAuthorized()): ?>
        ...
        <div class="pCartQuantity">
            <span class="text">Остаток:</span>
                ...
                <span class="pCartQnt"><?=$arResult['CATALOG_QUANTITY'] //=getProductRestsInterval($arResult)?></span>
        </div>
            <?else:?>	
        <div class="pCartQuantity">
            <span class="text">Остаток:</span>

                <span class="pCartQnt"><?=getProductRestsInterval($arResult)?></span>
        </div>
            <?endif;?>
<?endif; ?>
    </div>
    ...
    <div class="pTechnicals">
        ...
        <ul class="pTechnicalsSecond prodTechnical">
            <? if ($arResult['PROPERTIES']['REFERENCE']['VALUE']): ?>
                <li>
                    <span class="pSecondHeader">Референс компании:</span>
                    <span class="pSecondValue"><?= $arResult['PROPERTIES']['REFERENCE']['VALUE']; ?></span>
                </li>
            <? endif; ?>
            <? if ($arResult['PROPERTIES']['SKU']['VALUE']): ?>
                <li>
                    <span class="pSecondHeader">Артикул поставщика:</span>
                    <span class="pSecondValue"><?= $arResult['PROPERTIES']['SKU']['VALUE']; ?></span>
                </li>
            <? endif; ?>
            <li class="clear"></li>
