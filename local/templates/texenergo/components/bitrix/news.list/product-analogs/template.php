                    ...
                    <? foreach ($arResult["ITEMS_MODIF"] as $arItem): ?>
                        ...
                        <li class="product" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                            ...
                            <? if ($arItem["PROPERTIES"]["REFERENCE"]["VALUE"] != ""): ?>
                                <span class="sku">Референс: <? echo $arItem["PROPERTIES"]["REFERENCE"]["VALUE"]; ?></span>
                            <? endif ?>
                            <? if ($arItem["PROPERTIES"]["SKU"]["VALUE"] != ""): ?>
                                <span class="sku">Артикул: <? echo $arItem["PROPERTIES"]["SKU"]["VALUE"]; ?></span>
                            <? endif ?>
                            <?php
