...
if (count($arResult["ITEMS"]) > 0) {
    ...
    <section class="pAdditional">
        <header>
            <h3 class="pAdditionalHeader">Аналоги</h3>
            <? if ($itemCount > 3) : ?>
        ...
        <div class="j-additional-carousel">
            <div class="item">
                ...
                <ul class="pAdditionalUl">
                    ...
                    <? foreach ($arResult['ITEMS_MODIF'] as $arItem): ?>
                        ...
                        <li class="product clearfix" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                            ...
                            if ($arItem["PROPERTIES"]["REFERENCE"]["VALUE"] != "") {
                                echo "<span class='sku'>Референс: " . $arItem["PROPERTIES"]["REFERENCE"]["VALUE"] . "</span>";
                            }

                            if ($arItem["PROPERTIES"]["SKU"]["VALUE"] != "") {
                                echo "<span class='sku'>Артикул: " . $arItem["PROPERTIES"]["SKU"]["VALUE"] . "</span>";
                            }
							?>
