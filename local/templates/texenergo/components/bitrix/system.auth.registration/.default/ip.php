<form method="post" id="register_form_ip" data-messages="yes" class="form" action="<?= $arResult["AUTH_URL"] ?>#cartForm-3"
...
<input type="hidden" name="PERSON_TYPE" value="<?= SALE_PERSON_IP; ?>"/>
...
<div class="cartForm-group clearfix">
    <div class="cartForm-field">
        ...
        <input type="text" class="cartForm-input required" name="PROFILE[OGRN]"
               value="<?= $arResult['PROFILE']['OGRN']; ?>" data-title="ОГРН" data-rules="integer|exact_length[15]">
    </div>
    ...
    <div class="cartForm-field">
        ...
        <input type="text" class="cartForm-input required" name="PROFILE[INN]"
               value="<?= $arResult['PROFILE']['INN']; ?>" data-rules="integer|exact_length[12]" data-title="ИНН">
    </div>
    <div class="cartForm-field no-margin">
...
<? if (false) :?>
    <div class="cartForm-field">
        ...
        <input type="text" class="cartForm-input" name="PROFILE[KPP]"
               value="<?= $arResult['PROFILE']['KPP']; ?>" data-title="КПП">
    </div>
<? endif;?>
    <div class="cartForm-field no-margin">
    ...
    <div class="delivery-address" style="display:<?=$display?>">
        ...
        <div class="formRow clearfix">
            <div class="formParent clearfix">
                <div class="formChild form-50">
                    <span class="formLabel">Улица</span>
                    <input class="formInput" type="text" name="PROFILE[STREET_DELIVERY]"
            ...
            <div class="formParent no-margin clearfix">
                <div class="formChild form-10">
                    <span class="formLabel">Дом</span>
                    <input class="formInput" type="text" name="PROFILE[HOUSE_DELIVERY]"
                ...
                <div class="formChild form-10 no-margin">
                    <span class="formLabel">Этаж</span>
                    <input class="formInput" data-rules="integer" type="text" name="PROFILE[STAGE_DELIVERY]"
                           value="<?= $arResult['PROFILE']['STAGE_DELIVERY']; ?>" data-title="Этаж">
                </div>
            </div>
        </div>
    </div>
