...
<section class="main main-about main-newspage detail-publication">
	<div class="twelve">
		...
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				"=_ID" => $arSection['ID'], //$arResult["VARIABLES"]["SECTION_ID"],
...
Теги:<span>авторское право, патенты, закон</span>
</div>
<?endif;?>
<div class="publication-slider">
<h3 class="header-blk-slider">Дополнительные материалы</h3>
<?//pr($arParams)?>
        <?// block slider publications?>
	<?global $section_code_publication;?>
	<?$section_code_publication = $arResult["VARIABLES"]["SECTION_CODE"]?>
	<?$APPLICATION->IncludeFile('/include/block_publications_slider.php');?>
</div>
<?if (false):?>
<div class="publication-comments">
<h3>Всего отзывов: 5</h3>
</div>
<?endif;?>