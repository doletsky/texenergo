...
<div class="subscribe-form" >
	...
	<?endforeach;?>
		...
		<div class="subscribe-tbl">			
			<!-- <tr> -->
			<div class="specials footer_pricelist"><a href="/price_list/">Прайс-листы</a></div>
			<div class="specials footer_catalogs"><a href="/manufacturers/">Каталоги производителей</a></div>
