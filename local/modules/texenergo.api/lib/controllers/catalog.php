...
class Catalog
{
	...
	$iNumPage  = 1;
	    ...
	    $arAllowedFields = ['ID','NAME','EXTERNAL_ID','CODE','DATE_CREATE','TIMESTAMP_X','PROPERTY_SKU_VALUE','CATALOG_QUANTITY'];	
	    ...
	    if (isset($arParam['SELECT']) && !empty($arParam['SELECT'])) {
			...
			$arSelect = ['CODE','PROPERTY_SKU','EXTERNAL_ID','NAME', 'ID','CATALOG_QUANTITY','DATE_CREATE','TIMESTAMP_X'];
		}
