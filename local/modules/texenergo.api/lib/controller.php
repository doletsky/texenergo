...
class Controller extends Router
{
    ...
    {
        if (!$this->mode) {
            $this->mode = parent::getParameter()['OPERATING_MODE'];
        }
    ...
    {
	//echo "LOG:".parent::getParameter()['SUPPORT_USE_LOG'];
	//die();	
        if (isset(parent::getParameter()['SUPPORT_USE_LOG'])) {
		//echo "LOG:Делать".parent::getParameter()['SUPPORT_LOG_PATH'];
	//die();
            $pathLog = $_SERVER['DOCUMENT_ROOT'] . parent::getParameter()['SUPPORT_LOG_PATH'];
