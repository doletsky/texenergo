...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/main/admin/user_edit.php");
...
<?if ($arUser['UF_COMPANY_ID'] != ""):?>
    <?echo BeginNote();?>
    <a target="_blank" href="/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=27&type=orders&ID=<?=$arUser['UF_COMPANY_ID'];?>&lang=ru&find_section_section=-1&WF=Y">Ссылка на контрагента</a><br>
    <?echo EndNote();?>
<?endif;?>
<?
